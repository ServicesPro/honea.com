	...
	<header class="header">
		<div class="h-wrap">
			<div class="h_content">
				...
				<div id="logo">
					<div>
						<a href="{{ url('/') }}"><img src="{{ asset('image/honea.png') }}" width="140px" alt="logoDistribution" /></a>
					</div>
				</div>
				<div id="search">
					<div id="search-content">
						<div id="search-form">
							...
							<img id="ic_detete" src="{{ asset('icon/ic_detele.svg') }}" height="20" width="20" alt="image"
                            ...
                            <a href="{{ route('login') }}" class="btn_connect">
                                ...
                                {{-- <script>
                                    ...
                                    if (username != null && username != "") {
                                        ...
                                        document.querySelector(".btn_connect").href = "compte.html";
                                    } else {
                                        document.querySelector(".btn_connect span").textContent = "Connexion";
                                        document.querySelector(".btn_connect").href = "connection.html";
                                    }
                                </script> --}}
                            </a>
                        @endauth
			...
			{{-- <div id="search-form2">
				<div id="find2">
					...
					<input id="editTextM" onfocus="displayMobileSearch()" type="text" name="qsearch"
						placeholder="Rechercher un produit ou une catégorie...">
					<img id="ic_detete2" src="{{ asset('icon/ic_detele.svg') }}" height="20" width="20" alt="image"
						style="visibility: hidden">
					<div class="sug"></div>
				</div>
			</div> --}}
		...
		<div class="footer_wrapper">
			<div class="footer1">
				<div class="col1" style="display: flex; flex-direction: column;">
					<a href="{{ url('/') }}"><img src="{{ asset('image/honea.png') }}" alt="logoDistribution" /></a>
