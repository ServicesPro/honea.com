    ...
    <header>
        <div class="header-top-wrapper-2 border-bottom-2">
            <div class="header-info-wrapper pl-200 pr-200">
                ...
                <div class="electronics-login-register">
                    <ul>
                        <li><a href="{{ url('/admin/profile') }}"><i class="pe-7s-users"></i>Mon Compte</a></li>
                        <li><a data-toggle="modal" data-target="#exampleCompare" href="#"><i
                                    class="pe-7s-repeat"></i>Comparer</a></li>
                        <li><a href="wishlist.html"><i class="pe-7s-like"></i>Liste de souhait</a></li>
        ...
        <div class="header-bottom pt-40 pb-30 clearfix">
            <div class="header-bottom-wrapper pr-200 pl-200">
                <div class="logo-3">
                    <a href="{{route('home')}}">
                        <img style="height: 40px" src="/assets/img/logo/honea.png" alt="">
                    </a>
                </div>
                <div class="categories-search-wrapper">
                    ...
                    <div class="categories-wrapper">
                        <form action="{{route('products.search')}}" method="GET">
                            <input name="query" placeholder="Entrez un mot clé" type="text">
                    ...
                    <div class="col-lg-3 col-md-6 col-xl-3">
                        <div class="footer-widget mb-40">
                            ...
                            <div class="footer-widget-content-3">
                                <ul>
                                    <li><a href="login.html">Se connecter ici</a></li>
                                    <li><a href="cart.html">Historique du panier</a></li>
                                    <li><a href="checkout.html">Historique des paiements</a></li>
                                    {{-- <li><a href="shop.html">Product Tracking</a></li> --}}
                                    <li><a href="register.html">S'enregister</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7">
                        <div class="copyright f-right mrg-5">
                            <p>
                                Copyright ©
                                <a target="_blank" href="https://e-servicespro.com/" rel="noopener noreferrer">E-Services</a> 2021 . All Right Reserved.
                            </p>
                        </div>
                    </div>
                </div>
